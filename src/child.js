...
async function setUpComponentsLocally() {
    ...
    await evalLocalSystemDriver('import_access_control',   path.join(__dirname, '../public/visifile_drivers/controls/import_access.js'),{username: "default", reponame: "import_access_control", version: "latest"})
