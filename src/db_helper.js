...
module.exports = {
    ...
    async.map([
                    ...
                    "CREATE TABLE IF NOT EXISTS ipfs_hashes                     (ipfs_hash TEXT, stored_as_local_file TEXT, content_type TEXT, ping_count INTEGER, last_pinged INTEGER, UNIQUE(ipfs_hash));",
