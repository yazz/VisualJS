...
module.exports = {
    ...
    async.map([
            ...
            "CREATE TABLE IF NOT EXISTS app_list (id TEXT, base_component_id TEXT, app_name TEXT, app_description TEXT, icon_image_id TEXT, ipfs_hash TEXT, system_code_id TEXT);",
            "CREATE INDEX IF NOT EXISTS app_list_idx                      ON app_list (id);",


            "CREATE TABLE IF NOT EXISTS component_list (id TEXT, base_component_id TEXT, component_name TEXT, component_description TEXT, icon_image_id TEXT, ipfs_hash TEXT, system_code_id TEXT);",
