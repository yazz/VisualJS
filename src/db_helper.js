...
module.exports = {
    ...
    async.map([
        ...
        "CREATE INDEX IF NOT EXISTS search_rows_hierarchy_child_hash_idx2 ON search_rows_hierarchy_2 (child_hash);",
            ...
            "CREATE TABLE IF NOT EXISTS system_process_info (process	TEXT PRIMARY KEY, process_id	TEXT, running_since	TEXT, job_count	INTEGER, last_driver TEXT, last_event TEXT, job_priority INTEGER);",
