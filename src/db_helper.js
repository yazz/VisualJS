...
module.exports = {
    ...
    async.map([
            ...
            "CREATE TABLE IF NOT EXISTS labels (id TEXT, label_owner_type TEXT, label_owner_type_2 TEXT, label_owner_name TEXT,  label_name TEXT, label_value TEXT);",
