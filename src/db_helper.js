...
module.exports = {
    ...
    async.map([
            ...
            "CREATE TABLE IF NOT EXISTS system_code (id TEXT, ipfs_hash_id TEXT, creation_timestamp INTEGER, parent_id TEXT, fk_user_id TEXT, on_condition TEXT, component_scope TEXT, base_component_id TEXT,method TEXT, code TEXT, max_processes INTEGER, code_tag TEXT,  display_name TEXT, component_options TEXT, logo_url TEXT, visibility TEXT, interfaces TEXT, use_db TEXT, editors TEXT, read_write_status TEXT, properties TEXT, component_type TEXT, control_sub_type TEXT, edit_file_path TEXT,  component_type_v2 TEXT, subscribed TEXT, code_tag_v2 TEXT, num_changes INTEGER, code_changes TEXT, last_read_from_ipfs INTEGER, score INTEGER, score_reason TEXT, score_total INTEGER);",
