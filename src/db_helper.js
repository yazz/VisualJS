...
module.exports = {
    ...
    async.map([
            ...
            "CREATE TABLE IF NOT EXISTS component_usage (base_component_id TEXT, child_base_component_id TEXT,  child_code_id TEXT  );",
            "CREATE INDEX IF NOT EXISTS component_usage_base_component_id_idx ON component_usage (base_component_id);",
            "CREATE INDEX IF NOT EXISTS component_usage_child_base_component_id_idx ON component_usage (child_base_component_id);",
            "CREATE INDEX IF NOT EXISTS component_usage_child_code_id_idx ON component_usage (child_code_id);",
            ...
            "CREATE TABLE IF NOT EXISTS system_code (id TEXT, base_component_id TEXT, display_name TEXT, component_type TEXT, creation_timestamp INTEGER, parent_id TEXT, fk_user_id TEXT,code TEXT, code_tag TEXT,  component_options TEXT, logo_url TEXT, visibility TEXT, interfaces TEXT, use_db TEXT, editors TEXT, read_write_status TEXT, properties TEXT, edit_file_path TEXT,  num_changes INTEGER, code_changes TEXT, last_read_from_ipfs INTEGER, score INTEGER, score_reason TEXT, score_total INTEGER);",
