...
module.exports = {
    ...
    async.map([
            ...
            "CREATE TABLE IF NOT EXISTS code_tags (id TEXT, base_component_id TEXT, code_tag TEXT, fk_system_code_id TEXT, fk_user_id TEXT);",
