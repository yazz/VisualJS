...
module.exports = {
    ...
    async.map([
                    ...
                    "CREATE TABLE IF NOT EXISTS ipfs_hashes                     (ipfs_hash TEXT, stored_as_local_file TEXT, content_type TEXT, stored_in_local_file INTEGER, read_from_local_file INTEGER, stored_in_ipfs INTEGER, sent_to_peer INTEGER, read_from_local_ipfs INTEGER, read_from_peer_ipfs INTEGER, read_from_peer_file INTEGER , error TEXT , ping_count INTEGER, last_pinged INTEGER, temp_debug_content TEXT,  UNIQUE(ipfs_hash));",
