...
module.exports = {
    ...
    async.map([
                    ...
                    "CREATE TABLE IF NOT EXISTS ipfs_hashes                     (ipfs_hash TEXT, stored_as_local_file TEXT, content_type TEXT, stored_in_ipfs INTEGER, stored_in_peer INTEGER, ping_count INTEGER, last_pinged INTEGER, temp_debug_content TEXT,  UNIQUE(ipfs_hash));",
