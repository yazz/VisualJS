...
module.exports = {
    ...
    async.map([
                    ...
                    "CREATE TABLE IF NOT EXISTS ipfs_hashes_queue_to_download   (ipfs_hash TEXT, created_time_millis INTEGER, status TEXT, server TEXT, read_from TEXT, time_read_millis INTEGER  ,  UNIQUE(ipfs_hash));",
