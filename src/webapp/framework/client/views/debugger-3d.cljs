(ns webapp.framework.client.debugger-3d
  ...
  (:use
        [webapp.framework.client.coreclient :only [width height popup do-before-remove-element new-dom-id
                                                   find-el clj-to-js sql-fn
                                                   header-text body-text body-html make-sidebar
