{
    ...
    templateDefinition:
        //*** pipeline_editor_vue_html_template_start ***//
        `
                ...
                <div    v-if='(design_mode && (design_mode_pane.type=="control_details_editor"))'
                    ...
                    <div  v-bind:style='"padding:7px;border: 5px solid lightgray;background: white;;overflow:none;height:100%; overflow: auto; width:100%; "'>
                        ...
                        <component  v-bind:id='active_form + "_" + model.forms[active_form].components[active_component_detail_index].name + (design_mode?"_design":"")'
                                    ...
                                    v-bind:is='model.forms[active_form].components[active_component_detail_index].code_id?model.forms[active_form].components[active_component_detail_index].code_id:yz.baseComponentIdReturnsCommitId[model.forms[active_form].components[active_component_detail_index].base_component_id]'
...
`
        //*** pipeline_editor_vue_html_template_end ***//
}
