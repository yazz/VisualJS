...
`
    ...
    getHashesAfterTimestamp:        async function  (  thisDb  ,  timestampMillis  ) {
        ...
        if (  (typeof timestampMillis == 'undefined')  ||  (timestampMillis == null)  ) {
            ...
            listOfHashes = await mm.getQuickSql(thisDb, "select  ipfs_hash, local_time_millis  from  ipfs_hashes  where  scope='GLOBAL' and local_time_millis > ?  limit 10" , [ timestampMillis ])
        }
