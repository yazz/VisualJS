        ...
        methods: {
            ...
            getPods: async function() {
                ...
                for (var x = 0 ; x < result.length ; x++ ){
                    ...
                    if (result[x].status.initContainerStatuses) {
                        if (result[x].status.initContainerStatuses.length > 0) {
                            newPod.ready = "" + result[x].status.initContainerStatuses[0].ready
                        } else {
                            newPod.ready = false
                        }
                    } else {
