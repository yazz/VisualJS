                        ...
                        <div    v-bind:refresh='refresh'
                          ...
                          <div     v-if='design_mode && isValidObject(active_component_index) && isVisible(active_form,active_component_index)'
                                   ...
                                   v-bind:style='"background: white;padding:0px; z-index: 21474836;opacity:1;position: absolute; "  +
                                        ...
                                        "width: 30px; height: 30px; line-height:30px;text-align: center;vertical-align: middle;"'
                                   zzz="//zzz"
                                   v-on:click='globalEditorCommunicationArea.lastEditingAppBaseComponentId = editingAppBaseComponentId; globalEditorCommunicationArea.lastEditingAppCodeId = editingAppCodeId;$event.stopPropagation();$root.$emit("message", { type:  "fork_component", base_component_id:   model.forms[active_form].components[active_component_index].base_component_id})'
                          >
