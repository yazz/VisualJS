...
sub_components(["app_editor_3","appEmbed","vb_editor_component","input_control","button_control","label_control","threedee_item_control","threedee_control","table_control"])
is_app(true)
description('VB App')
...
//alert(parentId +": = (" + parentOffsetX + "," + parentOffsetY + ")")
         ...
         myDataRenderFunction: function(data) {
             ...
             var template =
               "<div  style='overflow:hidden ;text-overflow: ellipsis;border-radius: 1px;margin: 0px;padding:0px;border:0px;font-family:verdana,helvetica;font-size: 13px;'>" +
                    center +
               "</div>";
             return template;
         },
