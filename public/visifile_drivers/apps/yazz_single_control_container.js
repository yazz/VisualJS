...
formEditor({
  ...
  "default_form": "Form_1",
  "app_selected": false,
  "id": "yazz_single_control_container",
...
base_component_id("yazz_single_control_container")
component_type("SYSTEM")
visibility("PRIVATE")
...
*/
    ...
    //** gen_start **//
                ...
                Vue.component('yazz_single_control_container', {
      props: [ "args"],
      template:
`<div   v-bind:id='uid2'
        v-if='uid2 != null'
...
`
        ...
        //-------------------------------------------------------------------
            ...
            var sql =    "select  cast(code as text)  as  code  from  released_components  where " +
