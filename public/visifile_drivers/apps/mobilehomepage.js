...
*/
    console.log(`calling await loadUiComponentsV4("app_editor_3")`)
    //await loadUiComponentsV4("app_editor_3")
    console.log(`calling await loadUiComponentsV4("app_editor_3") loaded`)

    Vue.component('mobilehomepage', {
    ...
    <div    v-for="(item, index) in intro_apps"
        ...
        <div    v-if="(edit_app == item.data.id)"
                ...
                <component  id="editor_component2"
                            ...
                            :is='"app_editor_3"'
                            v-bind:app_base_component_id='item.data.id'
      ...
      methods: {
         ...
         ,
          ...
          addLogoForApp: async function(appId) {
             ...
             // search
             //
              let sql2 =    "select  base_component_id,  app_icon_data as logo_url   from  released_components  " +
                  " inner JOIN " +
                  "     icon_images ON released_components.icon_image_id = icon_images.id " +
                  "where " +
                  "    component_type = 'app'" +
