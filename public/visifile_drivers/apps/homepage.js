...
`<div   v-bind:refresh='refresh'
    ...
    <div    style='vertical-align:top;padding:10px; margin:0;padding-top: 15px;padding-bottom: 0px;padding-bottom:0px; background-color: black;font-weight: bold;padding-left: 27px;'
            ...
            <div    v-bind:refresh='refresh'
                    ...
                    <div    style="display: inline-block;border:0px; padding: 0px; margin: 0px;background-color: black;position:absolute;width:10px;height:10px;left:0px;top:0px;background-color:darkgray;"></div>

                    <div    style="display: inline-block;border:0px; padding: 0px; margin: 0px;background-color: black;position:absolute;width:10px;height:10px;left:20px;top:0px;background-color:darkgray;"></div>

                    <div    style="display: inline-block;border:0px; padding: 0px; margin: 0px;background-color: black;position:absolute;width:10px;height:10px;left:10px;top:10px;background-color:darkgray;"></div>

                    <div    style="display: inline-block;border:0px; padding: 0px; margin: 0px;background-color: black;position:absolute;width:10px;height:10px;left:0px;top:20px;background-color:darkgray;"></div>
        ...
        <h1 style='vertical-align:top;display:inline-block;font-size:100px; text-align: center;margin: 0px;padding-left:70px;'>
            ...
            class='btn btn-info btn-lg'
                    v-on:click='copyAndEditApp($event,"new_microservice")'>
                    <img    src='/driver_icons/microservice.png'
                            style='position:relative;max-width: 70px; left:0px; top: 0px;max-height: 70px;margin-left: auto;margin-right: auto;display: inline-block;'
                            >
                    </img>
                * Microservice
                        ...
                        <div    v-if='(preview_app_id == item.data.id) && (!edit_app)'
                            ...
                            <div    v-if='(preview_app_id == item.data.id) '
                                    ...
                                    <button style='position:absolute;top:250px;left:20px;opacity:0.9;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius: 5px;margin-bottom:10px;margin-left:40px;padding:10px;font-size:20px;z-index:2147483647;'
                                            ...
                                            v-on:click='window.open(location.protocol + "//" + location.hostname + ":" + location.port + "/app/" + item.data.id + ".html", item.data.id)'>
