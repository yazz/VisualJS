...
// the blockly compiler to make valid Yazz code
//
// --------------------------------------------------------------------
...
//
//  input:        none
//  output:       the Yazz code represented by blockly
...
function getBlocklyValue()
{
  ...
  var inline = Blockly.Yazz.workspaceToCode(headlessWorkspace);
...
//
//  input:        none
//  output:       the Yazzscript code represented by blockly with no
//                macros
//  dependencies: The global blockly workspace
//
// --------------------------------------------------------------------
function getBlocklyOptimizedValue()
{
  ...
  var inline = Blockly.YazzOptimized.workspaceToCode(headlessWorkspace);
  headlessWorkspace.dispose();
  var code = inline;
