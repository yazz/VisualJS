...
Visual Javascript is a Low Code tool for building internal web apps. It can run on your desktop PC using Docker or NodeJS, or on a server with Kubernetes or NodeJS. To develop apps, you start up Visual Javascript, create the app in your web browser, and share the URL. However, it is probably not suitable for building the next great operating system. The sweet spot is for building small GUI apps or microservices. Many demo apps can be found at https://yazz.com (Yazz sponsors development of the tool).
