...
Visual Javascript is a tool for building webapps on your intranet. It runs on PC/Mac (desktop application or NodeJS), or on a Linux/Windows server (Docker, Kubernetes or NodeJS). To develop an app:
