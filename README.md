...
Yazz Pilot is a browser based tool for building internal web apps, using JavaScript for glue code. It can connect to Rest APIs, Postgres or other enterprise stuff. There is a demo here (Only works on desktops and Chrome right now):
