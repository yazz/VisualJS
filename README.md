...
Then in early 2014 he also discovered Facebook React and incorporated a ClojureScript library called Om (https://github.com/swannodette/om) by David Nolen into Coils. This was the single largest change to Coils, so big that it was a breaking change as all previous Coils apps (such as NemCV) used imperative UI libraries like Domina, whereas the new Coils would use Om and a reactive UI.
